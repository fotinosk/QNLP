...
from qnlp.image_tower.classification.ttn_quadtree_classification_model import QuadPatchTTN, DEVICE, LEARNING_RATE, EPOCHS, BOND_DIM, CP_RANK, DROPOUT, PATCH_SIZE, BATCH_SIZE
...
def train(log_run: bool = True):
    ...
    if log_run:
        run = wandb.init(project="quad-image-classifier", name="attempt-1", save_code=True)
