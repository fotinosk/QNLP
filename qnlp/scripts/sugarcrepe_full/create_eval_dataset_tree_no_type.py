"""Create the SugarCrepe-full evaluation dataset from the tree-no-type atlas.

Set PARSER_VERSION=tree_no_type before importing constants so the derived dir
and dataset output name are auto-versioned (-> sugarcrepe_full_eval_tree_no_type).
"""
...
def run() -> None:
    create_dataset(
        ...
        output_name="sugarcrepe_full_eval",
