"""Compile SugarCREPE++ atlas into CCG tensor diagrams using tree-reader (NO_TYPE mode).
...
logger = setup_logger(log_name="sugarcrepepp_process_tree")
...
def run() -> None:
    ...
    logger.info("SugarCREPE++ tree-no-type compilation complete.")
