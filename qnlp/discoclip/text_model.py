...
class EinsumModel(nn.Module):
    ...
    def reset_parameters(self, symbols: List[Symbol] = None): # type: ignore
        """
    ...
    def remove_symbols(self, symbols: List[Symbol]):
        ...
        for idx in indices_to_remove:
            ...
            del self.weights[idx] # type: ignore
            del self.sizes[idx]
    ...
    def _forward_single(self, input: tuple[str, List[Symbol]]) -> torch.Tensor:
        ...
        return einsum(einsum_expr, *[self.sym2weight[sym] for sym in symbols]) # type: ignore
    ...
    def load_state_dict(self, state_dict: Dict[str, Any], strict: bool = True): # type: ignore
