...
* **✅ INVESTIGATION CONCLUDED 2026-08-04.** Four statements the data supports, and one it does not:
  ...
  * **So the pre-registered "compositional advantage does not hold in the vision tower" branch is the one that fired**, and the CLIP-vs-TTN headline is untouched *and unsupported* by C6 — it rests on the COCO/ARO/SugarCrepe line. C6 was meant to supply its mechanism and does not.
