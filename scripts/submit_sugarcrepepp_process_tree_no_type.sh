...
# SugarCREPE++ is small (~13k sentences) so 4 workers is ample.
#$ -pe smp 5
#$ -R y
#$ -S /bin/bash
#$ -j y
...
echo "Compiling SugarCREPE++ captions into tree-no-type CCG diagrams..."
$PYTHON -m qnlp.scripts.sugarcrepepp.process_tree_no_type
