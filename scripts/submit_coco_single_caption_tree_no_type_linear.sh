...
# --- Experiment config: LINEAR contractions, TTN image tower (unfrozen) ---
...
export MLFLOW_RUN_NAME="${RUN_NAME:-coco_sc_tree_lin}"
...
echo "Embedding dim: $ML_EMBEDDING_DIM   Non-linear: $ML_USE_NON_LINEAR_CONTRACTIONS   Frozen: false"
