...
export MLFLOW_RUN_NAME="${RUN_NAME:-coco_mc_exp_bond20}"
...
echo "Gate strategy: per_symbol_mean_propagation"
echo "Bypass: word_mean_pool"
...
$PYTHON -m qnlp.scripts.coco_multi_caption_expressive.run
